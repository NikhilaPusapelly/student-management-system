...
login_student_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "login_student_img.png"))
login_admin_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "admin_img.png"))
add_student_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "add_student_img.png"))
locked_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "locked.png"))
unlocked_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "unlocked.png"))
add_student_pic_icon = tk.PhotoImage(file=os.path.join(BASE_DIR, "add_student_img.png"))
...
def draw_student_card(student_pic_path, student_data):
    ...
    student_card = Image.open(os.path.join(BASE_DIR, "student_card_frame.png"))
...
branch_list = ['CSE', 'CSM', 'CSC', 'IT', 'ECE', 'EEE', 'MECH', 'CIVIL']
    ...
    def check_input_validation():
        if student_name_ent.get() == '':
            ...
            if pic_path.get() != '':
                ...
                resize_pic.save(os.path.join(BASE_DIR, "temp_pic.png"))

                read_data = open(os.path.join(BASE_DIR, "temp_pic.png"), 'rb')
                pic_data = read_data.read()
                read_data.close()


            else:
                read_data = open(os.path.join(BASE_DIR, "graduated.png"), 'rb')
                pic_data = read_data.read()
                read_data.close()
